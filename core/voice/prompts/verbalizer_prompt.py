...
_REWRITING: List[str] = [
    ...
    (
        "Before reading a list, say how many items it has, then walk "
        'through them in order: "there are three points in the list, '
        'the first one is ..., the second is ..., the third is ...".'
    ),
